<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="博主号" prop="bozhuhao">
          <el-input v-model="ruleForm.bozhuhao" 
              placeholder="博主号" clearable  :readonly="ro.bozhuhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="博主号" prop="bozhuhao">
              <el-input v-model="ruleForm.bozhuhao" 
                placeholder="博主号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="博主名" prop="bozhuming">
          <el-input v-model="ruleForm.bozhuming" 
              placeholder="博主名" clearable  :readonly="ro.bozhuming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="博主名" prop="bozhuming">
              <el-input v-model="ruleForm.bozhuming" 
                placeholder="博主名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tupian = true;
          ...
          if(o=='bozhuhao'){
            this.ruleForm.bozhuhao = obj[o];
	    this.ro.bozhuhao = true;
            continue;
          }
          if(o=='bozhuming'){
            this.ruleForm.bozhuming = obj[o];
	    this.ro.bozhuming = true;
            continue;
          }
          if(o=='fabushijian'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.bozhuhao!=''&&json.bozhuhao){
                this.ruleForm.bozhuhao = json.bozhuhao
	    		this.ro.bozhuhao = true;
		}
		if(json.bozhuming!=''&&json.bozhuming){
                this.ruleForm.bozhuming = json.bozhuming
	    		this.ro.bozhuming = true;
		}
        } else {
	...
	this.ruleForm.wenzhangneirong = this.ruleForm.wenzhangneirong.replace(reg,'../../../springboot45y5d/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `bozhuwenzhang/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.bozhuwenzhangCrossAddOrUpdateFlag = false;
						 this.parent.search();
