      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='bozhu'" class="input-group">
			   <div class="label">博主号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.bozhuhao" class="input" type="text" placeholder="博主号">
			   </div>
			 </div> -->
			<el-form-item label="博主号" class="input" v-if="tableName=='bozhu'">
			  <el-input v-model="ruleForm.bozhuhao" autocomplete="off" placeholder="博主号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='bozhu'" class="input-group">
			   <div class="label">博主名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.bozhuming" class="input" type="text" placeholder="博主名">
			   </div>
			 </div> -->
			<el-form-item label="博主名" class="input" v-if="tableName=='bozhu'">
			  <el-input v-model="ruleForm.bozhuming" autocomplete="off" placeholder="博主名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='bozhu'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="确认密码" class="input" v-if="tableName=='bozhu'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='bozhu'">
			...
			<el-form-item label="电子邮箱" class="input" v-if="tableName=='bozhu'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((!this.ruleForm.bozhuhao) && `bozhu` == this.tableName){
        this.$message.error(`博主号不能为空`);
        return
      }
      if((!this.ruleForm.bozhuming) && `bozhu` == this.tableName){
        this.$message.error(`博主名不能为空`);
        return
      }
      ...
      if((this.ruleForm.mima!=this.ruleForm.mima2) && `bozhu` == this.tableName){
	    this.$message.error(`两次密码输入不一致`);
	    return
      }
      ...
      if(`bozhu` == this.tableName && this.ruleForm.lianxidianhua&&(!this.$validate.isMobile(this.ruleForm.lianxidianhua))){
        this.$message.error(`联系电话应输入手机格式`);
        return
      }
      if(`bozhu` == this.tableName && this.ruleForm.dianziyouxiang&&(!this.$validate.isEmail(this.ruleForm.dianziyouxiang))){
